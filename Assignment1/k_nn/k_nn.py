...
train_scores, valid_scores = validation_curve(val_k_nn, X, Y, "n_neighbors", n_neighbors, cv=5)
...
train_sizes, train_scores, validation_scores = learning_curve(learning_k_nn, X, Y, cv=5, train_sizes=train_size)
train_scores_mean = np.mean(train_scores, axis=1)
