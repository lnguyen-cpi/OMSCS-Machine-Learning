...
import hiive_local.visualization.mdpviz.mdp_spec
import hiive_local.visualization.mdpviz.reward
from hiive_local.visualization import mdpviz
from hiive_local.visualization.mdpviz.dsl import context as dsl_context
from hiive_local.visualization.mdpviz.dsl import ast
...
def reward(value):
    return ast.Reward(hiive_local.visualization.mdpviz.reward.Reward(value))
...
def new():
    ...
    dsl_context.mdp_spec = hiive_local.visualization.mdpviz.mdp_spec.MDPSpec()
